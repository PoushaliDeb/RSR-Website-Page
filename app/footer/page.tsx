      ...
      <div style={styles.footerContainer}>
        ...
        <div style={styles.footerSection}>
          ...
          <span style={styles.socialIcon}>
            <Link href="https://facebook.com" target="_blank" style={{ textDecoration: "none", color: "inherit" }}>
              <img 
               src="facebook-logo-3.png" 
               alt="Facebook" 
          ...
          <span style={styles.socialIcon}>
            <Link href="https://x.com/" target="_blank" style={{ textDecoration: "none", color: "inherit" }}>
              <img 
               src="twitter-2.webp" 
               alt="Twitter" 
            ...
            <span style={styles.socialIcon}>
            <Link href="https://www.linkedin.com/" target="_blank" style={{ textDecoration: "none", color: "inherit" }}>
              <img 
               src="linkedin-3.png" 
               alt="Linkedin" 
